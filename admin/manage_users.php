...
try {
    ...
    // Fetch all users from the `user2` table
    $users = $db->query("SELECT UID, name, email, phonenumber FROM user2")->fetchAll(PDO::FETCH_ASSOC);
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="delete_user.php?UID=<?php echo $user['UID']; ?>" onclick="return confirm('Are you sure you want to delete this user?');">Delete</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
